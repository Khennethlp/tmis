  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer ">
        <div class="col-sm-3">
          <button class="btn btn-block btn-del" onclick="delete_account();" style="height:34px;border-radius:.25rem;font-size:15px;font-weight:normal; box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.2);">Delete </button>
        </div>
        <div class="col-sm-3">
          <button class="btn subBtn btn-block" id="update_btn" onclick="update_account();" style="height:34px;border-radius:.25rem;font-size:15px;font-weight:normal; box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.5);">Update </button>
        </div>
      </div>
    </div>
  </div>
