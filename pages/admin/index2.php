              ...
              <div class="col-md-12 mb-3">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <input type="password" class="form-control" name="store_out_qr" id="store_out_qr" placeholder="QR Here..." onchange="insert_partsout()" oninput="trim_white_space(event);" autofocus autocomplete="off">
