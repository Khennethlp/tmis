<script>
    ...
    const update_account = () => {
        ...
        var usertype = document.getElementById('user_type_edit').value;
    ...
    const export_mlist = () => {
        var search = document.getElementById('acc_search').value;

        // Create a hidden form for submission
        var form = $('<form></form>').attr({
            method: 'POST',
            action: '../../process/admin/export/export_accounts.php'
        });
