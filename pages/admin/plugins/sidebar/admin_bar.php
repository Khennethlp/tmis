<aside class="main-sidebar sidebar-light-primary elevation-4" id="sidebar">
  ...
  <a href="index.php" class="brand-link">
    <img src="../../dist/img/warehouse.png" alt="Logo" class="brand-image img-square elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-bold text-dark">TMS INVENTORY</span>
